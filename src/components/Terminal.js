		...
		return (
			<div className="terminal">
				...
				<div className="terminalContent">
					...
					<div className="terminalblock">
						<img src="https://image.ibb.co/et1RRb/project_1.png" />
					</div>
					<div className="terminalblock">
						{' '}
						<img src="https://image.ibb.co/mdC5Kw/project_2.png" />
					</div>
					<div className="terminalblock">
						<h3>Struggles</h3>
						<p>
					...
					<div className="terminalblock">
						...
						<div className="terminalcode">
							<p>
								<a className="link" href="https://alexpalma.io/">
									Alex Palma
								</a>
							</p>
							<p>
								<a className="link" href="https://www.christengarcia.com/">
									Christen Garcia
								</a>
							</p>
							<p>
								<a className="link" href="https://isabellegaboc.netlify.com/">
									Isabelle Gaboc
								</a>
							</p>
							<p>
					...
					<div className="terminalblock">
						<img src="https://image.ibb.co/hTOCzw/project_3.jpg" />
					</div>
				</div>
			</div>
		)
